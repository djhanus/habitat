      ...
      <div class="contained">
        <?php if( have_rows('apply_sthree_expands') ): ?>
          <?php while( have_rows('apply_sthree_expands') ): the_row(); ?>
            <details>
              <summary><span><?php the_sub_field('apply_sthree_expands_title'); ?></span>
                <button>
              ...
              <div class="text-wrapper">
                <div class="container">
                  <div class="left">
                    <div class="text">
                      <?php the_sub_field('apply_sthree_expands_body'); ?>
                    </div>
                  </div>

                  <div class="right">
                    <div class="text">
                      <?php the_sub_field('apply_sthree_expands_body_right'); ?>
                    </div>
                  </div>

                  <div class="socials">
                    <div>
                      <?php if( have_rows('apply_sthree_expands_socials') ): ?>
                        <?php while( have_rows('apply_sthree_expands_socials') ): the_row(); ?>
                          <a href="<?php the_sub_field('apply_sthree_socials_facebook_url'); ?>" title="Facebook">
                          ...
                          <a href="<?php the_sub_field('apply_sthree_socials_twitter_url'); ?>" title="Twitter">
                          ...
                          <a href="<?php the_sub_field('apply_sthree_socials_instagram_url'); ?>" title="Instagram">
                          ...
                          <a href="<?php the_sub_field('apply_sthree_socials_youtube_url'); ?>" title="Youtube">
