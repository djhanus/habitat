            ...
            <details>
              ...
              <div class="text-wrapper">
                ...
                <div class="right">
                  <h2>PAST PROJECTS</h2>
                  <ul>
                    <?php if( have_rows('waystogive_expands_past_projects_list') ): ?>
                      <?php while( have_rows('waystogive_expands_past_projects_list') ): the_row(); ?>
                        <li><?php the_sub_field('waystogive_expands_past_project_item'); ?>: <?php the_sub_field('waystogive_expands_past_project_text'); ?></li>
                      <?php endwhile; ?>
                    <?php endif; ?>
                  </ul>
                </div>
